...
$dyn_table = "";
$sql = mysql_query("SELECT * FROM products ORDER BY category DESC LIMIT 16");
$i = 0;
...
include "storescripts/connect_to_mysql.php"; 
$dyn = "";
$sql = mysql_query("SELECT * FROM products ORDER BY price DESC LIMIT 16");
$i = 0;
$productCount = mysql_num_rows($sql); 
if ($productCount > 0) {
	$i = 0;
$dyn = '<table height="300px" align="center">';
while($row = mysql_fetch_array($sql)){ 
    ...
    if ($i %8 == 0) { 
		...
		$dyn .= '<tr height="300px"align="center">
		               <td>
						<a href="product.php?id=' . $id . '"><img style="border:#666 0px solid;" src="inventory_images/' . $id . '.jpg" alt="' . $product_name . '" width="200" height="200"  /></a>
						<br>' . $product_name . '<br>
						' . $price . '<br>
        ...
        $dyn .= '<td><a href="product.php?id=' . $id . '"><img style="border:#666 0px solid;" src="inventory_images/' . $id . '.jpg" alt="' . $product_name . '" width="200" height="200"  /></a>
						<br>' . $product_name . '<br>
						' . $price . '<br>
						 <a class="btn btn-primary"href="product.php?id=' . $id . '">View Details</a>
						</td>';
...
<?php echo $dyn ; ?>		
		<br><br><br>
					...
					<div class="col-md-6 col-md-offset-3 text-center colorlib-heading">
						<h2><span>Best Selling Food Grains</span></h2>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved </i> by <a href="http://rakttdaan.in" target="_blank">Rakttdaan Team</a>
